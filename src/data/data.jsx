...
export const projects = [
  {
    ...
    tagCategories: ["mobile", "backend", "backend", "backend"],
    repoUrls: [
  ...
  },
  {
    ...
    period: "2025",
    title: "PAICAT",
    company: "Trabajo final · Analista de Sistemas UTN",
    intro: "Plataforma web para la gestión integral del curso de ingreso universitario de la UTN FRLP.",
    description:
      "Desarrollo de una plataforma web para digitalizar y optimizar la gestión del ingreso universitario de la UTN FRLP utilizando Laravel. El sistema administra comisiones con control de cupos, alumnos, docentes, asistentes con validación automática de porcentajes mínimos y calificaciones por materia con recuperatorios.",
    details: [
      "Administración de comisiones con control de cupos",
      "Gestión de alumnos y docentes",
      "Registro de asistente con validación automática",
      "Carga de calificaciones por materia",
      "Esquema de roles (Admin, Coordinador, Docente, Alumno)",
      "Reportes en PDF y Excel",
      "Docker + Docker Compose (PHP, Nginx, MariaDB)",
    ],
    thumbnail: paicat1,
    images: [paicat1, paicat2],
    role:
      "Análisis, diseño e implementación del módulo de Asistencias, definiendo reglas de negocio, modelado de datos y lógica de validación automática.",
    ...
    tagCategories: ["backend", "devops", "database"],
    repoUrls: [
  ...
  },
  {
    ...
    period: "2025",
    title: "EventHub",
    company: "Proyecto académico · UTN FRLP",
    intro: "Aplicación web para gestión y venta de entradas con foco en buenas prácticas y trabajo colaborativo.",
    description:
      "Desarrollo de una aplicación web para la gestión y venta de entradas utilizando Django con renderizado SSR. Proyecto enfocado en mantenibilidad, testing y CI/CD.",
    details: [
      "Vistas y templates con renderizado SSR en Django",
    ...
    role:
      "Crecimiento profesional con GitHub Actions, CI/CD y metodología ágil. Entendí la importancia del testing, code review y procesos colaborativos.",
    mainTags: ["Django", "Python", "Docker"],
    allTags: ["Django", "Python", "Docker", "Playwright", "GitHub Actions", "CI/CD", "Ruff", "Git", "SSR"],
    tagCategories: ["backend", "backend", "devops"],
    repoUrls: [
